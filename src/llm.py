...
# MODEL = os.getenv("NIM_MODEL", "nvidia/llama-3.1-nemotron-ultra-253b-v1")
# MODEL = os.getenv("NIM_MODEL", "openai/gpt-oss-120b")
MODEL = os.getenv("NIM_MODEL", "deepseek-ai/deepseek-v3.1")
# MODEL = os.getenv("NIM_MODEL", "deepseek-ai/deepseek-r1-0528")
